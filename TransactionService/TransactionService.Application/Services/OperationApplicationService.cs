...
{
    public class OperationApplicationService : IOperation
    {   

        private readonly IMediatorHandler _mediator;

        public OperationApplicationService(IMediatorHandler mediator)
        {
            _mapper = mapper;
            ...
            _logger = loggerFactory.CreateLogger<OperationApplicationService>();
